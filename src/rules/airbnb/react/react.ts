...
const rules: RuleConfig = {
	...
	rules: {
		...
		// 'forwardRef' is no longer necessary in React 19 and onwards.
		//
		// 'react/forward-ref-uses-ref': 'error',

		// Enforce a specific function type for function components
		// https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/function-component-definition.md
		// Use '@kylsgl/no-top-level-function-expression' as an alternative
		//
		...
		'@stylistic/jsx-curly-spacing': [
			'error',
			{ allowMultiline: true, when: 'never' },
		],
		...
		// Already covered in '@stylistic/indent'
		//
		...
		// Use 'eslint/func-names' as an alternative for 'allowFunctions: false'
		//
		// 'react/jsx-no-bind': [
		// 	'error',
		// 	{
		...
		// Already covered in '@stylistic/jsx-curly-brace-presence'
		//
		...
		// Already covered in '@stylistic/no-multi-spaces'
		//
		...
		// New rules assumes that only stateless functional components are used
		//
		...
		// https://github.com/jsx-eslint/eslint-plugin-react/blob/mast	er/docs/rules/no-did-update-set-state.md
		//
